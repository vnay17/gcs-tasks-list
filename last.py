...
def run_dataflow_job(project_id, temp_location,destination_file,file_name,save_main_session=True):
    ...
    with beam.Pipeline(options=options) as pipeline:
        ...
        source_data =(
            pipeline
            | 'Read from BigQuery' >> beam.io.ReadFromBigQuery(query="SELECT * FROM `dataflow-bigquery-402307.gcs_to_big_flow.gcs_to_big_flow_1` where time > '2023-11-06 14:37:03.039544 UTC' ",
...
if __name__ == '__main__':
    ...
    source_table = 'ddataflow-bigquery-402307.gcs_to_big_flow.gcs_to_big_flow_1'
